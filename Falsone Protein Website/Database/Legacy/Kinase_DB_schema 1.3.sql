...
CREATE TABLE Substrate_site_Kinase (
	Subsite_kinase_ID INTEGER(5) NOT NULL,
	Substrate_ID INTEGER(5) NOT NULL,
	Kinase_name VARCHAR(10) NOT NULL,
	PRIMARY KEY (Subsite_kinase_ID),
	FOREIGN KEY (Kinase_name) REFERENCES Kinase(Kinase_name),
	FOREIGN KEY (Substrate_ID) REFERENCES Substrate_phosphosite(Substrate_ID)
);

CREATE TABLE Substrate_phosphosite (
	Substrate_ID INTEGER(7) NOT NULL,
